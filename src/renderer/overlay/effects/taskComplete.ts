...
// A one-shot "that finished" celebration, fired when the analyser sees a region
// that was churning (a build compiling, a video rendering, a download bar
// filling) go quiet. The whole point is that you can look away from a long task
// and still know the moment it's done — so this is deliberately eye-catching for
// a beat, then gone.
...
export function drawTaskComplete(
