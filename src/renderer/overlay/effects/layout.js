 ...
 */
export function legibleText(ctx) {
 ...
 */
export function drawPanel(ctx, x, y, w, h, accent, pad = 10, radius = 7) {
    const [r, g, b] = accent;
 ...
 */
export function panelAnchor(pos, W, H, panelW, panelH, margin = 15) {
