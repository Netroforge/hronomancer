...
export const useOverlayStore = defineStore('overlay', {
    ...
    actions: {
        ...
        hydrate(s) {
            ...
            if (Date.now() < suppressStateUntil)
                return;
            ...
            if (s.glitchConfig)
                this.glitchConfig = JSON.parse(JSON.stringify(s.glitchConfig));
            if (s.layout)
                this.layout = cloneLayout(s.layout);
